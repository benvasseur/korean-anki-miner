...
// DeepL is the default: its free tier (1M characters, lifetime — it does not
// reset) covers hundreds of thousands of single-word clicks, where Papago's
// allowance is metered per month.
